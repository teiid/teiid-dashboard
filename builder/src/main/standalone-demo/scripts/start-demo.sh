...
#
# Startup script for the Teiid Dashboard Builder demo.
...
echo "*****************************************************************************"
echo "*"
echo "* Starting the Teiid Dashboard Builder Demo"
echo "*"
...
$JAVA $JAVA_OPTIONS -jar jetty-runner.jar teiid-dashbuilder-demo.war
